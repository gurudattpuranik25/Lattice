...
import { Home, Plus, BookOpen, FolderOpen, Settings, LogOut, Menu, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      <div className="p-6 flex items-center gap-2.5">
        ...
        <span className="font-heading font-bold text-lg tracking-tight text-white">LATTICE</span>
      </div>
      ...
      <div className="p-4 border-t border-white/5">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm text-zinc-400 hover:text-white hover:bg-white/5 rounded-xl w-full transition-all duration-200"
        >
          <LogOut size={16} />
          Sign Out
        </button>
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:block fixed left-0 top-0 bottom-0 w-[280px] bg-zinc-950 border-r border-white/5 z-30">
        {sidebarContent}
      </aside>
    </>
  );
